const roles = [
  {
    ...
    badge: "Current",
    bullets: [
      "Configured a Microsoft Copilot agent to automate UAT test case creation and review for the project team — reducing preparation time from 4 days to 4 hours and freeing the team to focus on higher-value delivery work.",
      "Supported end-to-end delivery of a Policy Administration System (PAS) implementation as Project Manager Assistant — contributing to requirements gathering, UAT execution, compliance stakeholder coordination, and go-live readiness across Technology, Operations, and Regulatory teams.",
